    ...
    <div class="col-md-6">
        ...
        <div class="form-group map">
            ...
            <div class="form-group">
                ...
                <input type="text" name="yt" value="<?php echo $testimoni['video'] ?>" class="form-control">
            </div>
            <div class="form-group">
                <label>Judul Video</label>
                <input type="text" name="nama_yt" value="<?php echo $testimoni['nama'] ?>" class="form-control">
            </div>
            <hr>
